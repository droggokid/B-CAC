...
*/
     ...
     *  @{
     */
        #define ledRed_INTR_NONE      (uint16)(0x0000u)
        #define ledRed_INTR_RISING    (uint16)(0x0001u)
        #define ledRed_INTR_FALLING   (uint16)(0x0002u)
        #define ledRed_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define ledRed_INTR_MASK      (0x01u) 
#endif /* (ledRed__INTSTAT) */
...
/* SIO registers */
#if defined(ledRed__SIO_CFG)
    #define ledRed_SIO_HYST_EN        (* (reg8 *) ledRed__SIO_HYST_EN)
    #define ledRed_SIO_REG_HIFREQ     (* (reg8 *) ledRed__SIO_REG_HIFREQ)
    #define ledRed_SIO_CFG            (* (reg8 *) ledRed__SIO_CFG)
    #define ledRed_SIO_DIFF           (* (reg8 *) ledRed__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define ledRed_0_INTTYPE_REG 		(* (reg8 *) ledRed__0__INTTYPE)
#endif /* (ledRed__INTSTAT) */
