...
#endif /* defined(SPIS_2_IntClock__CFG3) */

#define SPIS_2_IntClock_Enable()                       SPIS_2_IntClock_Start()
#define SPIS_2_IntClock_Disable()                      SPIS_2_IntClock_Stop()
#define SPIS_2_IntClock_SetDivider(clkDivider)         SPIS_2_IntClock_SetDividerRegister(clkDivider, 1u)
#define SPIS_2_IntClock_SetDividerValue(clkDivider)    SPIS_2_IntClock_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define SPIS_2_IntClock_SetPhaseValue(clkPhase)        SPIS_2_IntClock_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(SPIS_2_IntClock__CFG3) */
