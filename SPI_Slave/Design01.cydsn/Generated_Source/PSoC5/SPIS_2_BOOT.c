...
#if defined(CYDEV_BOOTLOADER_IO_COMP) && (0u != ((CYDEV_BOOTLOADER_IO_COMP == CyBtldr_SPIS_2) || \
                                          (CYDEV_BOOTLOADER_IO_COMP == CyBtldr_Custom_Interface)))


/*******************************************************************************
* Function Name: SPIS_2_CyBtldrCommStart
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPIS_2_CyBtldrCommStop
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPIS_2_CyBtldrCommReset
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPIS_2_CyBtldrCommWrite
********************************************************************************
*
* Summary:
         ...
         
{
    ...
    (void) SPIS_2_ReadTxStatus();

    /* Write TX data using blocking function */
    #if(0u != SPIS_2_MODE_USE_ZERO)
        SPIS_2_WriteTxDataZero(pData[buf_index]);
        buf_index++;
    #endif /* (SPIS_2_MODE_USE_ZERO == 1u) */

    /* Write TX data using blocking function */
    do
    {
        SPIS_2_WriteTxData(pData[buf_index]);
        buf_index++;
    }while(buf_index < size);

    while(0u != timeoutMs)
    {
        if(0u != (SPIS_2_ReadTxStatus() & SPIS_2_STS_SPI_DONE))
        {
            /* Return success code */
            *count = size;
...
/*******************************************************************************
* Function Name: SPIS_2_CyBtldrCommRead
********************************************************************************
*
* Summary:
         ...
         
{
        ...
        */
        if(0u != SPIS_2_GetRxBufferSize())
        {
            ...
            */
            do
            {
                oldDataCount = SPIS_2_GetRxBufferSize();
                CyDelay(SPIS_2_BYTE2BYTE_TIME_OUT);
            }while(SPIS_2_GetRxBufferSize() > oldDataCount);
            status = CYRET_SUCCESS;
            break;
        }
    ...
    *count = 0u;
    ...
    while(SPIS_2_GetRxBufferSize() > 0u)
    {
        tempCount = SPIS_2_GetRxBufferSize();
        *count  =(*count) + tempCount;
        ...
        if(*count < size)
        {
            for (iCntr = 0u; iCntr < tempCount; iCntr++)
            {
                ...
                pData[dataIndexCntr] = SPIS_2_ReadRxData();
                dataIndexCntr++;
            }
...
#endif /* if defined(CYDEV_BOOTLOADER_IO_COMP) && (0u != ((CYDEV_BOOTLOADER_IO_COMP == CyBtldr_SPIS_2) || \
                                          (CYDEV_BOOTLOADER_IO_COMP == CyBtldr_Custom_Interface)) */
